...
import 'package:movies_module/data/datasources/hive_datasource_impl.dart';
...
void main() {
  ...
  group('toggleFavorite', () {
    ...
    test(
      ...
      () async {
        ...
        verify(mockBox.put(testMovie.id, MovieMapper.entityToMap(testMovie))).called(1);
      },
    );
  ...
  group('loadMovies', () {
    final testMovieMap = MovieMapper.entityToMap(testMovie);
